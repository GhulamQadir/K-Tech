        ...
        <div className='row'>
          ...
          <div className='col-md-4'>
            <div className='service_div_mobile'>
              ...
              <p className='home_divs_content'>The world is going mobile, as if that’s news. So why not be a part of the fastest growing market in the world, and create an app – together, that is a reflection of innovation and perfection. We do extreme research on market that what is the actual demand of today's market and how to present your brand that matches the expectations of real market user of that particular thing.</p>
            </div>
          </div>
        </div>
      </div>
